...
<?=head_rel($album['denumire']. ' - Mikrokosmos')?>
...
<?=template_meniuri()?>
    ...
    <div class="prezentare">
        ...
        <div class="container">  
            <input type="button" value="Înapoi la discografie" onclick="location.href='discografie.php'" class="buton-back" id="back">
            <?php 
            ...
            <div class="row album"> <!-- TITLU, POZA DE COPERTA, CHENARE CARE DUC SPRE DESCRIERE, VERSIUNI SI LINK-URI EXTERNE -->
                ...
                <div class="col-lg-3 meniu-album">
                    <div>
                        <input type="button" value="DESCRIERE" onclick="location.href='discografie-album.php?id=<?=$id_album?>&detalii=descriere'" class="buton-back">
                    </div>
                    <div>
                        <input type="button" value="VERSIUNI" onclick="location.href='discografie-album.php?id=<?=$id_album?>&detalii=versiuni'" class="buton-back">
                    </div>
                    <div>
                        <input type="button" value="CÂNTECE" onclick="location.href='discografie-album.php?id=<?=$id_album?>&detalii=cantece'" class="buton-back">
                    </div>
                </div>
            </div>
